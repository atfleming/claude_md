...
- Always create `netlify.toml` at the repo root before the first deploy.
  Minimum config for a Vite/React static site:
  ```toml
  [build]
...
Use <picture> with a WebP source and the original as fallback:

<picture>
  <source srcSet="/images/output.webp" type="image/webp" />
  <img src="/images/input.PNG" alt="..." width="1200" height="800" />
</picture>
Add loading="lazy" to any image that is below the fold.
