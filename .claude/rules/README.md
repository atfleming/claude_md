...
| `3d-cinematic-design.md` | `**/*.{css,scss,html,jsx,tsx,vue,svelte,astro,mdx}` | Production pipeline for 3D/cinematic sites (stylescape → AI image → Spline → Unicorn Studio), composition rules, integration patterns, and performance/accessibility requirements. |
